...
class AccessibilityNodeInfoDumper {
    ...
    public static void dumpWindowHierarchy(com.raise.uiautomator.UiDevice device, OutputStream out) throws IOException {
    ...
    private static void dumpNodeRec(AccessibilityNodeInfo node, XmlSerializer serializer, int index,
        ...
        serializer.attribute("", "bounds", com.raise.uiautomator.AccessibilityNodeInfoHelper.getVisibleBoundsInScreen(
